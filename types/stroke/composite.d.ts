 ...
 */
export function ensureStrokeCompositeResources(ctx: import("../core/context.js").BrushContext, Renderer: object, Cwidth: number, Cheight: number, Density: number): object;
/**
